...
Твоя первая задача простая:

1. самому понять, как работает модель
2. зайти с минимального уровня
3. показать это нескольким людям
4. помочь им повторить те же действия
