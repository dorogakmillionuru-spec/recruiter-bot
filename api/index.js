...
Коротко: это онлайн-доска объявлений, типа Авито.
Только здесь можно не только размещать объявления, но и получать выплаты через бонусную программу.
Предприниматели размещают рекламу, а обычный человек может зарабатывать на этом же потоке.

Давай проще — тебе сейчас это как вариант заработка интересно или просто смотришь?
